...
var floorRotation = 0;
var collisionObstacle = 7;
var collisionBonus = 20;
var gameStatus = "play";
var cameraPosGame = 170;
var cameraPosGameOver = 330;
var monsterAcceleration = 0.0003;
...
var lightwhiteMat = new THREE.MeshPhongMaterial({
  color: 0xFFFFFF, 
  shading:THREE.FlatShading,
});
...
var greenMat = new THREE.MeshPhongMaterial({
  ...
  var lightpinkMat = new THREE.MeshPhongMaterial({
    color: 0xFCA3B7, 
    shading:THREE.FlatShading,
  });
...
Hero = function() {
  ...
  this.torso = new THREE.Mesh(torsoGeom, lightgreyMat);
  ...
  this.pants = new THREE.Mesh(pantsGeom, lightgreyMat);
  ...
  this.tail = new THREE.Mesh(tailGeom, lightwhiteMat);
  ...
  this.head = new THREE.Mesh(headGeom, lightgreyMat);
  ...
  this.cheekR = new THREE.Mesh(cheekGeom, lightpinkMat);
  ...
  this.nose = new THREE.Mesh(noseGeom, lightpinkMat);
  ...
  this.mouth = new THREE.Mesh(mouthGeom, lightgreyMat);
  ...
  this.pawFR = new THREE.Mesh(pawFGeom, whiteMat);
  ...
  this.pawBL = new THREE.Mesh(pawBGeom, whiteMat);
  ...
  this.earL = new THREE.Mesh(earGeom, lightgreyMat);
  ...
  this.iris = new THREE.Mesh(irisGeom, lightgreenMat);
...
BonusParticles = function(){
  ...
  this.parts = [];
  for (var i=0; i<10; i++){
    var partorange = new THREE.Mesh(bigParticleGeom, orangeMat);
    var partGreen = new THREE.Mesh(smallParticleGeom, greenMat);
    partGreen.scale.set(.5,.5,.5);
    this.parts.push(partorange);
    this.parts.push(partGreen);
    this.mesh.add(partorange);
...
Monster = function(){
  ...
  this.iris = new THREE.Mesh(irisGeom, redMat);
  this.iris.position.x = 1.2;
  this.iris.position.y = -1;
  this.iris.position.z = 1;
  this.eyeL.add(this.iris);
...
Carrot = function() {
  ...
  this.body = new THREE.Mesh(bodyGeom, orangeMat);
